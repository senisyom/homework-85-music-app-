...
import { deleteAlbum, publishAlbum } from "../app/features/Albums/albumThunk";
import { selectUser } from "../app/features/User/userSlice";
import { selectLoad } from "../app/features/Artists/artistsSlice";
        ...
        <div className="d-flex align-items-center">
          ...
          {user?.role === "admin" && (
            ...
            >
              {isPublished ? (
                <>
                  <span className="d-flex ">Published</span>
                ...
                <>
                  <span className="d-flex ">Unpublished</span>
